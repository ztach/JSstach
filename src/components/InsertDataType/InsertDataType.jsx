    ...
    return (
      ...
      render={({
        ...
        <Form onSubmit={handleSubmit}>
          <label className="Panel___down__right_label"> 
          ...
          <button className="Panel___down__right_btn"  type="submit">Save</button>
...
/**
 *           <button className="Panel___down__right_btn"  type="exit" onClick={onResetEditType} >Exit</button>
 * ----------------
        <label htmlFor="types" 
